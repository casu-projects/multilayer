...
/// <summary>드릴 포드 비활성화 (구 모드 DrillPodPatch.cs 이식 + 현행 바닐라 대응, 2026-08-03).
...
///    이 경로를 막지 않으면 OnUse만으로는 하강이 그대로 작동한다.</summary>
...
/// <summary>현행 바닐라 하강 경로 차단 — 전용 서버에서 OverrideComponent.Update를 무효화한다
/// (홀드 시간 누적, didTeleport, RegenerateWorld 전부 미실행).</summary>
