...
/// <summary>헤드리스(-batchmode -nographics) 환경에서는 Screen.resolutions가 비어 있어
/// 바닐라 Settings.DefaultSettings()가 IndexOutOfRangeException을 던지고, 이게 월드젠의
/// WorldPreprocess 코루틴을 죽여 세계 생성이 영구 정지한다. 더미 해상도를 채워 방지한다.</summary>
