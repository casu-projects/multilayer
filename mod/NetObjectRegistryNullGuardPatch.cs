...
/// <remarks>실제 시그니처는 (Component, out SyncInfo) — out 파라미터는 ByRef이므로
/// 속성의 argTypes로는 지정할 수 없어 TargetMethod()로 정확히 바인딩한다
/// (기존 속성 1개 타입 지정은 조회 실패 → PatchAll 중단 원인이었음).</remarks>
[HarmonyPatch]
